...
The property editor has a production-verified private-photo workflow: staff
...
Private offer letters and other property paperwork have a production-verified,
staff-only PDF workflow. Internal document verification does not publish or
send the file to buyers.
...
The deployed catalogue offers shareable price and plot-size ranges and newest,
...
The inventory-confirmation workflow is deployed. Property staff can attest to a
...
current page preserved while moving between lists. Won, lost, and spam stages
clear the reminder. This is an in-app staff queue; it does not send email or
messages.
